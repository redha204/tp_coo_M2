...
urlpatterns = [
    ...
    path(
        ...
        name="quantite-matiere-premiere-detail",
    ),
    path(
        "api/matiere-premiere/<int:pk>/",
        views.MatierePremiereDetailView.as_view(),
        name="matiere-premiere-detail",
    ),
    path(
        "api/metier/<int:pk>/", views.MetierDetailView.as_view(), name="metier-detail"
    ),
    path(
    ...
    path(
        "api/debit-energie/<int:pk>/",
        views.DebitEnergieDetailView.as_view(),
        name="debit-energie-detail",
    ),
    ...
    path(
        "api/utilisation-matiere-premiere/<int:pk>/",
        views.UtilisationMatierePremiereDetailView.as_view(),
        name="utilisation-matiere-premiere-detail",
    ),
    path(
        "api/approvisionnement-matiere-premiere/<int:pk>/",
        views.ApprovisionnementMatierePremiereDetailView.as_view(),
        name="approvisionnement-matiere-premiere-detail",
    ),
    path(
        "api/ressource-humaine/<int:pk>/",
        views.RessourceHumaineDetailView.as_view(),
        name="ressource-humaine-detail",
    ),
    path(
        "api/machine/<int:pk>/",
